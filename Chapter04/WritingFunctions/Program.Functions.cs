...
{
    /// <summary>
    /// Pass a 32-bit unsigned integer an it  will be converted into its ordinal equivalent.
    /// </summary>
    ...
    static int Factorial(int number)
    {
        if (number < 0)
        {
            throw new ArgumentOutOfRangeException(message:
                $"The factorial function is defined for non-negative integers. Input: {number}",
